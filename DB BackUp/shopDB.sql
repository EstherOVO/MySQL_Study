...
CREATE TABLE `index_tbl` (
  ...
  KEY `IDX_INDEX_TBL_FIRSTNAME` (`first_name`)
...
INSERT INTO `membertbl` VALUES ('Dang','당탕이','경기도 부천시 중동'),('Han','한주연','인천 남구 주안동'),('Jee','지운이','서울 은평구 증산동'),('Sang','상달이','경기 성남시 분당구');
...
--
-- Temporary view structure for view `uv_member_tbl`
--

DROP TABLE IF EXISTS `uv_member_tbl`;
/*!50001 DROP VIEW IF EXISTS `uv_member_tbl`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `uv_member_tbl` AS SELECT 
 1 AS `memberName`,
 1 AS `memberAddress`*/;
SET character_set_client = @saved_cs_client;

--
-- Final view structure for view `uv_member_tbl`
--
...
/*!50001 VIEW `uv_member_tbl` AS select `membertbl`.`memberName` AS `memberName`,`membertbl`.`memberAddress` AS `memberAddress` from `membertbl` */;
...
-- Dump completed on 2024-04-02 10:39:38
